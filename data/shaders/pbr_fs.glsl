...
void main()
{
	...
	vec4 albedoColor = texture(albedoTexture, vin.texcoord);
	if (/*0 == opaquePass && albedoColor.a >= 1.0
		|| */0 != opaquePass && albedoColor.a < 1.0)
	{
		discard;
	}
	...
	{
		accumulation = vec4(directLighting + ambientLighting, albedoColor.a);
		counter = 1.;
	}
}
